      ...
      <form>
        ...
        <div className="mb-6">
            ...
            />
                    ...
                    <button type="submit" className="w-full mb-6 px-7 py-3 text-sm uppercase rounded bg-blue-600 text-white font-medium hover:bg-blue-700 hover:shadow-lg shadow-md
                    focus:bg-blue-700 active:shadow-lg transition duration-150 ease-in-out">Create Listing</button>
      </form>
    </main>
  );
};
