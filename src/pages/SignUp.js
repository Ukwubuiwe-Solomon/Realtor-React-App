      ...
      <div className="flex justify-center items-center flex-wrap px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <button type="submit" className="bg-blue-600 text-white w-full px-7 py-3 font-medium uppercase text-xs rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800">Sign Up</button>
